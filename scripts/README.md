...
To access the competition datasets you would need to be invitied to the competition by the organizers. Contact **cohort-10@tri-ai.org** to get invited and to import the datasets to the notebooks.
...
To import them you can by searching for **BAAI-bge-base-finetune-agric-doc(tri-ai)** and **Bge reranker-large(tri-ai-agri)** when importing to the notebook.
